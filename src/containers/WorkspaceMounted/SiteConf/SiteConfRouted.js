  ...
  render() {
    return (
      <Routes>
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/etalage"
          exact
          render={({ match }) => {
            return (
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/sitereadme"
          exact
          render={({ match }) => {
            return (
              <SiteConfRouteDogFoodSingle
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/previewchecksettings"
          exact
          render={({ match }) => {
            return (
              <SiteConfRouteDogFoodSingle
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/projectreadme"
          exact
          render={({ match }) => {
            return (
              <SiteConfRouteDogFoodSingle
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/general"
          exact
          render={({ match }) => {
            return (
              <SiteConfRouteGeneral
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/model"
          exact
          render={({ match }) => {
            return (
              <SiteConfRouteModel
        ...
        <Route
          path="/sites/:site/workspaces/:workspace/siteconf/dogfoodIncludesMenu/:fileOverride"
          exact
          render={({ match }) => {
            return (
              <SiteConfRouteDogFoodSingle
                ...
                workspaceKey={decodeURIComponent(match.params.workspace)}
                fileOverride={
                  "quiqr/model/includes/" +
                  decodeURIComponent(match.params.fileOverride)
                }
              />
            );
          }}
