...
class SiteLibraryRouted extends React.Component {
  ...
  updateCommunityTemplates() {
    ...
    request.on("error", (err) => {
      this.setState({
        quiqrCommunityTemplatesError:
          "Can't download templates. Your computer might be offline.",
      });
    });
    ...
    request.on("response", (response) => {
      response.on("error", (error) => {
        this.setState({
          quiqrCommunityTemplatesError:
            "Can't download templates. Server might have problems.",
        });
      });
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.props.importSiteURL &&
      prevProps.importSiteURL !== this.props.importSiteURL
    ) {
      this.setState({
  ...
  async selectWorkspace(siteKey: string, workspace) {
    ...
    this.history.push(
      `/sites/${decodeURIComponent(siteKey)}/workspaces/${decodeURIComponent(
        workspace.key
      )}/home/init`
    );
  }
        ...
        >
          ...
          <MenuItem
            ...
            onClick={() => {
              ...
              window
                .require("electron")
                .shell.openExternal(siteconfig.homepageURL);
            }}
          >
            Open Homepage
          </MenuItem>
  ...
  renderSelectSites(source, sourceArgument) {
    ...
    if (
      ...
      (listingSource === "last" &&
        this.state.sitesListingView === "templates-quiqr-community")
    ) {
    ...
    return this.props.activeLibraryView === "cards"
      ? this.renderCards(sites, listTitle)
      : this.renderList(sites, listTitle);
  }
        ...
        <Routes>
          <Route
            ...
            render={({ match, history }) => {
              ...
              return this.renderSelectSites(url, null);
            }}
          />
          <Route
            ...
            render={({ match, history }) => {
              ...
              return this.renderSelectSites(refresh, null);
            }}
          />
          <Route
            path="/sites/:source"
            ...
            render={({ match, history }) => {
              ...
              return this.renderSelectSites(source, null);
            }}
          />
          ...
          <Route
            ...
            render={({ match, history }) => {
              ...
              return this.renderSelectSites(source, sourceArgument);
            }}
          />
          ...
          <Route
            ...
            render={({ match, history }) => {
              this.history = history;
              return this.renderSelectSites("last", null);
            }}
          />
          <Route
            path="/sites"
